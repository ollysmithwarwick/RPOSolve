...
!----------------------------------------------------------------------
 ...
 1 continue
   ...
   do j = 1, m
      ...
      do i = 1, j
         h(i,j) = dotprd(n,w,v(:,i))      !    h(i,j) = dotprd(n,w,v(1,i)) 
         w = w - h(i,j)*v(:,i)
      end do
